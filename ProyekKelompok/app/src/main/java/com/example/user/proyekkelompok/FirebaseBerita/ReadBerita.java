...
public class ReadBerita extends AppCompatActivity implements AdapterBeritaRecyclerView.FirebaseDataListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
         ...
         * Mengeset layout
         */
        setContentView(R.layout.activity_read_berita);
        ...
        database.child("barang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot noteDataSnapshot : dataSnapshot.getChildren()) {
                     ...
                     */
                    BeritaPen barang = noteDataSnapshot.getValue(BeritaPen.class);
                 ...
                 */
                adapter = new AdapterBeritaRecyclerView(daftarBarang, ReadBerita.this);
    ...
    public static Intent getActIntent(Activity activity){
        return new Intent(activity, ReadBerita.class);
    }

    @Override
    public void onDeleteData(BeritaPen barang, final int position) {
        /*
        ...
        if(database!=null){
            database.child("barang").child(barang.getKey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(ReadBerita.this,"success delete", Toast.LENGTH_LONG).show();
                }
            });
