    ...
    class GetDataAsync extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (null != modalList && modalList.size() > 0) {
                ...
                mRecyclerView.setAdapter(new MyRecyclerAdapter2(ProgramList.this, modalList));
                mRecyclerView.setLayoutManager(new LinearLayoutManager(ProgramList.this));
                mRecyclerView.setItemAnimator(new DefaultItemAnimator());
            } else {
                Toast.makeText(ProgramList.this, "Tidak Ada Data Ditemukan", Toast.LENGTH_SHORT).show();
            }
        }
    }
